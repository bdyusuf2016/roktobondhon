...
export const INITIAL_DEMO_USERS: User[] = [
  {
    id: 'user-superadmin',
    fullName: 'সুপার এডমিন (রক্তবন্ধন)',
...
export const INITIAL_PAYMENT_METHODS: PaymentMethodConfig[] = [
  ...
  },
  {
    ...
    accountType: 'merchant',
    instructionsBn: 'একাউন্ট নাম: রক্তবন্ধন মানবকল্যাণ সংস্থা। শাখা: ধামরাই শাখা, ঢাকা। রাউটিং নম্বর: ১২৫২৬xxxx। ব্যাংকিং অ্যাপ বা সরাসরি ব্রাঞ্চে জমা দেওয়া যাবে।',
    isActive: true,
  },
];
...
export const INITIAL_FUND_DONATIONS: FundDonation[] = [
  ...
  },
  {
    ...
    area: 'সাভার',
    message: 'অসহায় মানুষের জীবন বাঁচাতে রক্তবন্ধনের উদ্যোগকে সাধুবাদ জানাই।',
    isAnonymous: true,
    status: 'verified',
    verifiedBy: 'সুপার এডমিন',
...
export const INITIAL_FUND_DISBURSEMENTS: FundDisbursement[] = [
  {
    ...
    area: 'কালামপুর বাজার, ধামরাই',
    approvedBy: 'সুপার এডমিন (রক্তবন্ধন)',
...
export const INITIAL_BLOOD_CAMPS: BloodCamp[] = [
  {
    ...
    organizerName: 'রক্তবন্ধন ধামরাই টিম ও যুব রেড ক্রিসেন্ট',
  ...
  },
  {
    ...
    organizerName: 'রক্তবন্ধন সাভার শাখা',
  ...
  },
  {
    ...
    organizerName: 'রক্তবন্ধন মানিকগঞ্জ শাখা',

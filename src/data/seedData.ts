...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  // 1. ব্লাড অপারেশন ও ফিল্ড
  {
    key: 'manage_donors',
    labelBn: 'রক্তদাতা তথ্য যাচাই ও অনুমোদন',
    descriptionBn: 'নতুন রক্তদাতার তথ্য যাচাই, একাউন্ট অনুমোদন এবং প্রোফাইল নিয়ন্ত্রণ।',
    category: 'blood',
  },
  {
    key: 'manage_requests',
    labelBn: 'রক্তের জরুরি আবেদন অনুমোদন',
    descriptionBn: 'জরুরি রক্তের চাহিদা রিভিউ, সত্যায়ন এবং স্ট্যাটাস ট্র্যাকিং।',
    category: 'blood',
  },
  {
    key: 'record_donation',
    labelBn: 'রক্তদান সম্পন্ন রেকর্ড ও সনদ',
    descriptionBn: 'হাসপাতালে রক্তদান নিশ্চিতকরণ ও ডিজিটাল প্রশংসাপত্র প্রস্তুতকরণ।',
    category: 'blood',
  },
  {
    key: 'manage_camps',
    labelBn: 'রক্তদান ক্যাম্প ও ড্রাইভ পরিচালনা',
    descriptionBn: 'ক্যাম্পেইন শিডিউলিং, ভেন্যু নির্ধারণ, ভলান্টিয়ার অ্যাসাইন ও প্রি-রেজিস্ট্রেশন।',
    category: 'blood',
  },
  {
    key: 'manage_donor_import',
    labelBn: 'বাল্ক ডেটা ইমপোর্ট ও মাইগ্রেশন',
    descriptionBn: 'এক্সেল/সিএসভি ফাইল থেকে একসাথে বহু রক্তদাতার তথ্য প্ল্যাটফর্মে ইমপোর্ট।',
    category: 'blood',
  },

  // 2. ডিরেক্টরি ও নেটওয়ার্ক
  {
    key: 'manage_hospitals',
    labelBn: 'হাসপাতাল ও ব্লাড ব্যাংক ডিরেক্টরি',
    descriptionBn: 'হাসপাতাল ও ব্লাড ব্যাংকের তালিকা, আইসিইউ ও জরুরি হটলাইন তথ্য হালনাগাদ।',
    category: 'directory',
  },
  {
    key: 'manage_branches',
    labelBn: 'শাখা ও চ্যাপ্টার ব্যবস্থাপনা',
    descriptionBn: 'ধামরাই, সাভার, মানিকগঞ্জসহ নতুন আঞ্চলিক শাখা ও কো-অর্ডিনেটর নেটওয়ার্ক।',
    category: 'directory',
  },
  ...
  // 3. অর্থায়ন ও তহবিল
  {
    ...
    descriptionBn: 'বিকাশ, নগদ, ব্যাংকে প্রাপ্ত আর্থিক ডোনেশনের TrxID যাচাই ও ভেরিফিকেশন।',
    category: 'funds',
  },
  {
  ...
  },
  {
    ...
    descriptionBn: 'বিকাশ, নগদ বা ব্যাংক অ্যাকাউন্ট নম্বর ও অনুদান খাত যোগ/সম্পাদনা।',
    category: 'funds',
  },

  // 4. যোগাযোগ ও এনালিটিক্স
  {
    key: 'emergency_broadcast',
    labelBn: 'জরুরি অ্যালার্ট ও ব্রডকাস্ট',
    descriptionBn: 'জরুরি রক্তের প্রয়োজনে এসএমএস, হোয়াটসঅ্যাপ ও পুশ নোটিফিকেশন ব্রডকাস্ট।',
    category: 'communications',
  },
  {
    key: 'view_analytics',
    labelBn: 'এনালিটিক্স ও প্ল্যাটফর্ম রিপোর্ট',
    descriptionBn: 'রক্তদান প্রবণতা, ভৌগোলিক চাহিদা, ডোনার রিটেনশন ও অগ্রগতি পরিসংখ্যান।',
    category: 'communications',
  },
  {
    key: 'manage_sms_notifications',
    labelBn: 'এসএমএস গেটওয়ে ও নোটিফিকেশন টেমপ্লেট',
    descriptionBn: 'এসএমএস ব্যালেন্স রিচার্জ, স্বয়ংক্রিয় মেসেজ টেমপ্লেট ও ওয়েব পুশ কন্ট্রোল।',
    category: 'communications',
  },

  // 5. সিস্টেম, নিরাপত্তা ও কনফিগারেশন
  {
    key: 'manage_users',
    labelBn: 'ইউজার ও টিম মেম্বার একাউন্ট',
    descriptionBn: 'নতুন এডমিন/স্বেচ্ছাসেবক যোগ, ভূমিকা নির্ধারণ ও একাউন্ট নিয়ন্ত্রণ।',
    category: 'system',
  },
  {
    key: 'manage_roles_matrix',
    labelBn: 'রোল ও পারমিশন ম্যাট্রিক্স নিয়ন্ত্রণ',
    descriptionBn: 'কোন ভূমিকা কোন ফিচার ব্যবহার করতে পারবে তা ডায়নামিকভাবে পরিবর্তন (সুপার এডমিন এক্সক্লুসিভ)।',
    category: 'system',
  },
  {
    key: 'manage_settings',
    labelBn: 'হেডার, ফুটার ও প্ল্যাটফর্ম পলিসি',
    descriptionBn: 'ওয়েবসাইটের নাম, স্লোগান, নোটিশ ব্যানার, রক্তদানের নীতিমালা ও কভারেজ এলাকা।',
    category: 'system',
  },
  {
    key: 'view_system_health',
    labelBn: 'সিস্টেম হেলথ ও সার্ভার মনিটরিং',
    descriptionBn: 'ডাটাবেজ কানেক্টিভিটি, ক্লাউড স্টোরেজ, ক্যাশিং ও এপিআই ল্যাটেন্সি মেট্রিক্স।',
    category: 'system',
  },
  {
    key: 'manage_backup',

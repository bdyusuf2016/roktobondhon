...
const FAQS = [
  ...
  },
  {
    ...
    a: 'একদমই না! রক্তবন্ধন একটি সম্পূর্ণ স্বেচ্ছাসেবী ও অলাভজনক মানবিক সংগঠন। রক্তদান বা গ্রহণের ক্ষেত্রে যেকোনো প্রকার আর্থিক লেনদেন সম্পূর্ণ নিষিদ্ধ এবং দণ্ডনীয় অপরাধ।'
  },
  {

...
export const DEFAULT_SYSTEM_CONFIG: SystemConfig = {
  organization: {
    organizationName: 'রক্তবন্ধন (RoktoBondon)',
    organizationNameBn: 'রক্তবন্ধন রক্তদান সংগঠন',
    shortName: 'রক্তবন্ধন',
    ...
    descriptionBn: 'ধামরাই, সাভার ও মানিকগঞ্জে জরুরি রক্তের প্রয়োজনে নিঃস্বার্থ রক্তদাতাদের তাৎক্ষণিক সংযোগকারী প্ল্যাটফর্ম।',
  ...
  branding: {
    ...
    faviconUrl: '',
    primaryColor: '#dc2626',
    headerTitle: 'রক্তবন্ধন',
    headerSubtitle: 'ধামরাই • সাভার • মানিকগঞ্জ',
    headerSubtitleBn: 'ধামরাই • সাভার • মানিকগঞ্জ এলাকা',
    footerAboutBn: 'রক্তবন্ধন একটি সম্পূর্ণ অলাভজনক ও স্বেচ্ছাসেবী মানবিক উদ্যোগ। ধামরাই, সাভার ও মানিকগঞ্জে রক্তের সংকটে বিনামূল্যে সাহায্য করতে আমরা নিবেদিত।',
  ...
  website: {
    ...
    homepageSubtitle: 'ধামরাই, সাভার ও মানিকগঞ্জে জরুরি রক্তের প্রয়োজনে তাৎক্ষণিক রক্তদাতা খুঁজুন।',
    ...
    copyright: '© 2026 রক্তবন্ধন রক্তদান সংগঠন। সর্বস্বত্ব সংরক্ষিত।',
    socialLinks: {
      facebook: 'https://facebook.com/roktobondon',
    },
  },
  seo: {
    siteTitle: 'রক্তবন্ধন (RoktoBondon) - রক্তদান ও ডোনার প্ল্যাটফর্ম',
    siteTitleBn: 'রক্তবন্ধন — ধামরাই, সাভার ও মানিকগঞ্জের স্বেচ্ছাসেবী রক্তদান প্ল্যাটফর্ম',
    metaDescription: 'ধামরাই, সাভার ও মানিকগঞ্জ সহ সারাদেশে জরুরি রক্তের প্রয়োজনে রক্তদাতা অনুসন্ধান, রক্তের আবেদন ও স্বেচ্ছাসেবী রক্তদান নেটওয়ার্ক।',
    ...
    metaKeywords: 'রক্তদান, ব্লাড ডোনার, ধামরাই ব্লাড ডোনার, সাভার রক্তদাতা, মানিকগঞ্জ রক্তদান, Blood Donor Bangladesh, Dhamrai Blood, Savar Blood, RoktoBondon',
    ogTitle: 'রক্তবন্ধন (RoktoBondon) — রক্তের বন্ধনে বাঁচুক প্রতিটি প্রাণ',
    ogDescription: 'ধামরাই, সাভার ও মানিকগঞ্জে জরুরি রক্তের প্রয়োজনে তাৎক্ষণিক রক্তদাতা খুঁজুন ও আবেদন করুন।',
    ogImageUrl: 'https://bdyusuf2016.github.io/roktobondhon/assets/og-image.png',
    twitterCardType: 'summary_large_image',
    twitterHandle: '@roktobondon',
  ...
  gamification: {
    ...
    organizationSignatoryTitle: 'Lead Coordinator, RoktoBondon',
    organizationSignatoryNameBn: 'মুহাম্মদ ইউসুফ',
    organizationSignatoryTitleBn: 'কেন্দ্রীয় সমন্বয়ক, রক্তবন্ধন স্বেচ্ছাসেবী রক্তদান প্ল্যাটফর্ম',
  ...
  pwa: {
    appName: 'RoktoBondon Blood Donation Network',

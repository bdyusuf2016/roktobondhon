...
export const DEFAULT_SYSTEM_CONFIG: SystemConfig = {
  organization: {
    ...
    website: 'https://roktodanporibar.com/',
    facebookUrl: 'https://facebook.com/roktodanporibarkalampur',
  },
  branding: {
    logoUrl: `${(typeof import.meta !== 'undefined' && import.meta.env?.BASE_URL) || '/'}logo.png`,
    faviconUrl: `${(typeof import.meta !== 'undefined' && import.meta.env?.BASE_URL) || '/'}favicon.png`,
    primaryColor: '#dc2626',
  ...
  seo: {
    ...
    ogImageUrl: 'https://roktodanporibar.com/logo.png',
    twitterCardType: 'summary_large_image',
    twitterHandle: '@roktodanporibar',
    canonicalUrl: 'https://roktodanporibar.com/',

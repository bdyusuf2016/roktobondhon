-- ==============================================================================
-- র ক্ত ব ন্ধ ন (ROKTOBONDHON) - 100% CLEAN & FRESH DATABASE RESET SCRIPT
-- ==============================================================================
-- ⚠️ WARNING: Running this script will completely wipe all existing tables in
-- the public schema and recreate a brand-new, clean, production-grade schema.
-- ==============================================================================

-- 1. DROP ALL EXISTING TABLES & OBJECTS IN PUBLIC SCHEMA CLEANLY
DROP TABLE IF EXISTS public.verification_logs CASCADE;
DROP TABLE IF EXISTS public.audit_logs CASCADE;
DROP TABLE IF EXISTS public.notifications CASCADE;
DROP TABLE IF EXISTS public.payment_methods CASCADE;
DROP TABLE IF EXISTS public.fund_disbursements CASCADE;
DROP TABLE IF EXISTS public.fund_donations CASCADE;
DROP TABLE IF EXISTS public.camp_registrations CASCADE;
DROP TABLE IF EXISTS public.blood_camps CASCADE;
DROP TABLE IF EXISTS public.hospitals CASCADE;
DROP TABLE IF EXISTS public.donations CASCADE;
DROP TABLE IF EXISTS public.donor_requests CASCADE;
...
-- ==============================================================================
-- 3. DONORS TABLE (Full Profile & Directory)
-- ==============================================================================
...
-- ==============================================================================
-- 5. DONOR REQUESTS TABLE (Matching Invitations)
-- ==============================================================================
CREATE TABLE public.donor_requests (
  id TEXT PRIMARY KEY,
...
-- ==============================================================================
-- 6. DONATIONS TABLE (Logged Donation Histories)
-- ==============================================================================
...
-- ==============================================================================
-- 16. SYSTEM CONFIG TABLE (Platform Defaults & Governance)
-- ==============================================================================
...
CREATE INDEX idx_donors_district ON public.donors(district);
CREATE INDEX idx_donors_upazila ON public.donors(upazila);
CREATE INDEX idx_donors_availability ON public.donors(availability);
CREATE INDEX idx_donors_verification_status ON public.donors(verification_status);
CREATE INDEX idx_donors_matching_composite ON public.donors(blood_group, district, upazila, availability, verification_status);
...
CREATE INDEX idx_blood_requests_upazila ON public.blood_requests(upazila);
CREATE INDEX idx_blood_requests_emergency ON public.blood_requests(emergency_level);
CREATE INDEX idx_blood_requests_created_at ON public.blood_requests(created_at DESC);

CREATE INDEX idx_blood_camps_status ON public.blood_camps(status);
CREATE INDEX idx_blood_camps_district ON public.blood_camps(district);
CREATE INDEX idx_blood_camps_start_date ON public.blood_camps(start_date);
CREATE INDEX idx_camp_registrations_camp_id ON public.camp_registrations(camp_id);

CREATE INDEX idx_notifications_user_id ON public.notifications(user_id);
CREATE INDEX idx_donor_requests_donor_user_id ON public.donor_requests(donor_user_id);
...
-- Create Open Access & Admin Policies

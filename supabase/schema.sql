...
-- ==============================================================================
-- ROKTOBONDHON PHASE 1F-B: SEC-01 ANTI-ABUSE RATE LIMITING INFRASTRUCTURE
-- ==============================================================================
...
-- ==============================================================================
-- PHASE 1F-B: SEC-01 ANTI-ABUSE GATEWAY & RATE LIMITING
-- ==============================================================================
...
-- 3. Direct PostgREST INSERT Lockdown: camp_registrations
DROP POLICY IF EXISTS "Public can register for blood camps" ON public.camp_registrations;
...
-- 4. Direct PostgREST INSERT Lockdown: fund_donations
DROP POLICY IF EXISTS "Public can submit fund donation proof" ON public.fund_donations;
